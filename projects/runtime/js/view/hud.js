(function (window) {
    ...
    window.opspark.makeHud = function () {
        ...
        background = draw.rect(104, 20, 'white');
        draw.rect(102, 18, 'white', null, null, 1, 1, background);
        integrity.addChild(background);
        
        txtScore = draw.textfield('score : 000', "19px Arial", 'white', 'left');
        hud.addChild(txtScore);
        
        integrityMeter = draw.rect(1, 16, 'black');
